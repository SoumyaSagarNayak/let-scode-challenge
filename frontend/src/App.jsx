      ...
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <main style={{ flexGrow: 1 }}>
          <Routes>
            ...
            <Route path="/dashboard" element={<DashboardPage onExplainAi={handleOpenAi} />} />
            <Route path="/categories" element={<CategoryExplorerPage />} />
            <Route path="/category/:id" element={<CategoryDetailPage onExplainAi={handleOpenAi} />} />
            ...
            <Route path="/bookmarks" element={<BookmarksPage onExplainAi={handleOpenAi} />} />
